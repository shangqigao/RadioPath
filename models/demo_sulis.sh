...
python a_07explainable_AI/m_survival_analysis.py --wsi_dir $wsi_dir --img_dir $img_dir --lab_dir $lab_dir --save_pathomics_dir $save_pathomics_dir --save_radiomics_dir $save_radiomics_dir --save_clinical_dir $save_clinical_dir
